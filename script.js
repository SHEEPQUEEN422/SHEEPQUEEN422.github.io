...
const papers = [
    ...
    },
    {
        ...
        links: [],
        summary: "Team-built TikTok content-intelligence platform that turns trend signals into actionable content strategies and scripts; I owned the Next.js frontend, real-time pipeline progress, and results workflow for non-technical users.",
        new: true,
        category: "Product",
    },
    {
        ...
        summary: "A Playwright automation script that polls DMV appointment availability within a target date range, selects matching open slots, and completes the automated booking flow.",
        new: false,
        category: "Product",
    },
];
